package it.unibo.seiot.progetto3.smartdumpstermobileapp.utils;

public class C {
    public static final String APP_LOG_TAG = "BT CLN";
    public static final String URL = "http://aca28705.ngrok.io/api/app";
    public static final int DEPOSIT_ACTIVITY = 3;
    public  static final int ENABLE_WIFI_REQUEST = 2;
